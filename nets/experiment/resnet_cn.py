...
class ResNet_3head_cnn(nn.Module):
    def __init__(
            self,
        ...
        super(ResNet_3head_cnn, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
    ...
    def get_name(self):
        return 'resnet50_3head_n' 


class ResNet_3head_cnl(nn.Module):
    def __init__(
            self,
            block: Type[Union[BasicBlock, Bottleneck]]=Bottleneck,
            layers: List[int]=[3,4,6,3],
        ...
        super(ResNet_3head_cnl, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
    ...
    def forward(self, x: Tensor) -> Tensor:
        return self._forward_impl(x)
    def get_name(self):
        return 'resnet50_3head_l' 

class ResNet_2head_cnn(nn.Module):
    def __init__(
            self,
            block: Type[Union[BasicBlock, Bottleneck]]=Bottleneck,
            layers: List[int]=[3,4,6,3],
        ...
        super(ResNet_2head_cnn, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
    ...
    def forward(self, x: Tensor) -> Tensor:
        return self._forward_impl(x)
    def get_name(self):
        return 'resnet50_2head_n' 


class ResNet_2head_cnl(nn.Module):
    def __init__(
            self,
            block: Type[Union[BasicBlock, Bottleneck]]=Bottleneck,
            layers: List[int]=[3,4,6,3],
        ...
        super(ResNet_2head_cnl, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
...
if __name__ == '__main__':
    m = ResNet(num_classes1=2, num_classes2=3,num_classes3=4)
    # m = ResNet_3head(num_classes1=2, num_classes2=3,num_classes3=4)
