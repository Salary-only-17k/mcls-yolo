...
class dpconv(nn.Module):
    ...
    def forward(self,input):
        ...
        return out
def conv3x3(in_planes: int, out_planes: int,kernelsize:int=3, stride: int = 1, groups: int = 1, dilation: int = 1) -> nn.Conv2d:
...
class ResNet_3head_dpn(nn.Module):
    def __init__(
            self,
        ...
        super(ResNet_3head_dpn, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
...
class ResNet_3head_dpl(nn.Module):
    def __init__(
            self,
            block: Type[Union[BasicBlock, Bottleneck]]=Bottleneck,
            layers: List[int]=[3,4,6,3],
        ...
        super(ResNet_3head_dpl, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
...
class ResNet_2head_dpn(nn.Module):
    def __init__(
            self,
            block: Type[Union[BasicBlock, Bottleneck]]=Bottleneck,
            layers: List[int]=[3,4,6,3],
        ...
        super(ResNet_2head_dpn, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
...
class ResNet_2head_dpl(nn.Module):
    def __init__(
            self,
            block: Type[Union[BasicBlock, Bottleneck]]=Bottleneck,
            layers: List[int]=[3,4,6,3],
        ...
        super(ResNet_2head_dpl, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
