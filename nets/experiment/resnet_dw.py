...
class ResNet_3head_dwn(nn.Module):
    def __init__(
            self,
        ...
        super(ResNet_3head_dwn, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
...
class ResNet_3head_dwl(nn.Module):
    def __init__(
            self,
            block: Type[Union[BasicBlock, Bottleneck]]=Bottleneck,
            layers: List[int]=[3,4,6,3],
        ...
        super(ResNet_3head_dwl, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
...
class ResNet_2head_dwn(nn.Module):
    def __init__(
            self,
            block: Type[Union[BasicBlock, Bottleneck]]=Bottleneck,
            layers: List[int]=[3,4,6,3],
        ...
        super(ResNet_2head_dwn, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
...
class ResNet_2head_dwl(nn.Module):
    def __init__(
            self,
            block: Type[Union[BasicBlock, Bottleneck]]=Bottleneck,
            layers: List[int]=[3,4,6,3],
        ...
        super(ResNet_2head_dwl, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
