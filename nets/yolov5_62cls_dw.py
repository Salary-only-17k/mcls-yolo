...
import pprint
import torch
from lib.nets.utils.layer_tools import C3,Conv,Classify,make_divisible    
from lib.nets.utils.struct_cfg import yolov5_cfg

class yolov5_cls_sm_dw(nn.Module):
    def __init__(self,
                 cfg:dict,
                 flg:str='s'
                 ):
        """
            conv使用的正常卷积
        """
        super(yolov5_cls_sm_dw, self).__init__()
        self.cfg = cfg
        self.flg = flg
        if self.flg =='s':
...
class yolov5_cls_l_dw(nn.Module):
    def __init__(self,
                 cfg:dict,
                 ):
        super(yolov5_cls_l_dw, self).__init__()
        self.cfg = cfg
...
def yolov5n_cls_s_dw(num_cls1,num_cls2,num_cls3):    
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_n()
    return yolov5_cls_sm_dw(cfg,'s')


def yolov5s_cls_s_dw(num_cls1,num_cls2,num_cls3):    
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_s()
    return yolov5_cls_sm_dw(cfg,'s')

def yolov5l_cls_s_dw(num_cls1,num_cls2,num_cls3):
        cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_l()    
        return yolov5_cls_sm_dw(cfg,'s')

def yolov5m_cls_s_dw(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_m()
    return yolov5_cls_sm_dw(cfg,'s')

#~ m meaning middle-struct
def yolov5n_cls_m_dw(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_n()
    return yolov5_cls_sm_dw(cfg,'m')

def yolov5s_cls_m_dw(num_cls1,num_cls2,num_cls3):        
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_s()
    return yolov5_cls_sm_dw(cfg,'m')


def yolov5l_cls_m_dw(num_cls1,num_cls2,num_cls3):    
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_l() 
    return yolov5_cls_sm_dw(cfg,'m')
    
def yolov5m_cls_m_dw(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_m()
    return yolov5_cls_sm_dw(cfg,'m')


#~ l meaning large-struct
def yolov5n_cls_l_dw(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_n()
    return yolov5_cls_l_dw(cfg)
    

def yolov5s_cls_l_dw(num_cls1,num_cls2,num_cls3):    
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_s()
    return yolov5_cls_l_dw(cfg)
def yolov5l_cls_l_dw(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_l()
    return yolov5_cls_l_dw(cfg)

def yolov5m_cls_l_dw(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_m()
    return yolov5_cls_l_dw(cfg)
...
if __name__ == "__main__":
    import os
    func = yolov5s_cls_s_dw
    pth = "tmp.pt"

    data = torch.randn(1,3,224,224)
    model = func(4,3,2).run()
