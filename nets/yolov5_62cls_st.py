...
import sys
sys.path.append("..")
from nets.utils.layer_tools import C3,Conv,Classify,make_divisible    
from nets.utils.struct_cfg import yolov5_cfg

class yolov5_cls_sm(nn.Module):
    def __init__(self,
                 cfg:dict,
                 flg:str='s'
                 ):
        """
            conv使用的正常卷积
        """
        super(yolov5_cls_sm, self).__init__()
        self.cfg = cfg
        self.flg = flg
        if self.flg =='s':
...
class yolov5_cls_l(nn.Module):
    def __init__(self,
                 cfg:dict,
                 ):
        super(yolov5_cls_l, self).__init__()
        self.cfg = cfg
...
def yolov5n_cls_s(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_n()
    return yolov5_cls_sm(cfg,'s')
  
def yolov5s_cls_s(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_s()
    return yolov5_cls_sm(cfg,'s')


def yolov5l_cls_s(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_l()
    return yolov5_cls_sm(cfg,'s')

def yolov5m_cls_s(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_m()
    return yolov5_cls_sm(cfg,'s')

#~ m meaning middle-struct
def yolov5n_cls_m(num_cls1,num_cls2,num_cls3):  
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_n()
    return yolov5_cls_sm(cfg,'m')

def yolov5s_cls_m(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_s()
    return yolov5_cls_sm(cfg,'m')
 

def yolov5l_cls_m(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_l()
    return yolov5_cls_sm(cfg,'m')

def yolov5m_cls_m(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_m()
    return yolov5_cls_sm(cfg,'m')
...
def yolov5n_cls_l(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_n()
    return yolov5_cls_l(cfg)

def yolov5s_cls_l(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_s()
    return yolov5_cls_l(cfg)

def yolov5l_cls_l(num_cls1,num_cls2,num_cls3):
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_l()
    return yolov5_cls_l(cfg)

def yolov5m_cls_l(num_cls1,num_cls2,num_cls3):     
    cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_m()
    return yolov5_cls_l(cfg)
...
# #~ s meaning small-struct
# class yolov5n_cls_s:
#     def __init__(self,num_cls1,num_cls2,num_cls3):
#         super().__init__()
#         self.cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_n()
#     def run(self):
#         return yolov5_cls_sm(self.cfg,'s')
#     def get_name(self):
#         return "yolov5n_cls_s_st"

# class yolov5s_cls_s:
#     def __inint__(self,num_cls1,num_cls2,num_cls3):
#         super().__init__()
#         self.cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_s()
#     def run(self):
#         return yolov5_cls_sm(self.cfg,'s')
#     def get_name(self):
#         return "yolov5s_cls_s_st"

# class yolov5l_cls_s:
#     def __init__(self,num_cls1,num_cls2,num_cls3):
#         super().__init__()
#         self.cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_l()
#     def run(self):
#         return yolov5_cls_sm(self.cfg,'s')
#     def get_name(self):
#         return "yolov5l_cls_s_st"
# class yolov5m_cls_s:
#     def __init__(self,num_cls1,num_cls2,num_cls3):
#         super().__init__()
#         self.cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_m()
#     def run(self):
#         return yolov5_cls_sm(self.cfg,'s')
#     def get_name(self):
#         return "yolov5m_cls_s_st"
...
#         self.cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_n()
#     def run(self):
#         return yolov5_cls_sm(self.cfg,'m')
#     def get_name(self):
#         return "yolov5n_cls_m_st"
...
#         return yolov5_cls_sm(self.cfg,'m')
#     def get_name(self):
#         return "yolov5s_cls_m_st"

# class yolov5l_cls_m:
#     def __init__(self,num_cls1,num_cls2,num_cls3):
#         super().__init__()
#         self.cfg = yolov5_cfg(self,num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_l()
#     def run(self):
#         return yolov5_cls_sm(self.cfg,'m')
#     def get_name(self):
#         return "yolov5l_cls_m_st"
...
#         self.cfg = yolov5_cfg(num_classes1=num_cls1,num_classes2=num_cls2,num_classes3=num_cls3).yolov5_n()
#     def run(self):
#         return yolov5_cls_l(self.cfg)
#     def get_name(self):
#         return "yolov5n_cls_l_st"
...
#         return yolov5_cls_l(self.cfg)
#     def get_name(self):
#         return "yolov5m_cls_l_st"


if __name__ == "__main__":
    m = yolov5m_cls_l(4,3,2)
